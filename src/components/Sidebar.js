      ...
      <Sidebar.Items>
        <Sidebar.ItemGroup>
          <div className="border-solid border-b border-stroke pb-4">
            ...
            <Sidebar.Collapse
              className="hover:bg-primary group hover:text-white !text-15 p-4 rounded-[1.625rem] !font-medium"
              icon={() => (
                <Icon icon="hugeicons:home-01" width="24" height="24" className="group-hover:text-white" />
              )}
              label={<a className="!text-DustyBlue group-hover:!text-white" href="/dashboard">Dashboard</a>}
            >
              <Sidebar.Item href="/analytics" className="hover:text-secondary hover:bg-transparent !text-DustyBlue !text-15 !font-medium">Analytics</Sidebar.Item>
              <Sidebar.Item href="/seo-dashboard" className="hover:text-secondary hover:bg-transparent !text-DustyBlue !text-15 !font-medium">SEO Dashboard</Sidebar.Item>
              <Sidebar.Item href="/marketing" className="hover:text-secondary hover:bg-transparent !text-DustyBlue !text-15 !font-medium">Marketing</Sidebar.Item>
              <Sidebar.Item href="/logistics" className="hover:text-secondary hover:bg-transparent !text-DustyBlue !text-15 !font-medium">Logistics</Sidebar.Item>
            </Sidebar.Collapse>
            <Sidebar.Item href="/page-layouts"
              className="hover:bg-primary hover:text-white group !text-DustyBlue !text-15 p-4 rounded-[1.625rem] !font-medium"
              icon={() => (
